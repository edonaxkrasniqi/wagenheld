  ...
  return (
    <section id="ueber-uns" className="bg-surface-lowest scroll-mt-24">
      <Reveal className="max-w-[1280px] mx-auto px-5 md:px-10 py-20 md:py-28 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div>
          <SectionLabel className="mb-5">{aboutContent.label}</SectionLabel>
          ...
          <Link
            href="#kontakt"
            className="inline-flex items-center text-sm font-bold uppercase tracking-wider text-on-surface border-b-2 border-gold-ink pb-1 hover:text-gold-ink transition-colors"
          >
