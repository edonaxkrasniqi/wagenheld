...
const labelClasses =
  "block text-xs font-semibold uppercase tracking-wide text-white/80 mb-1.5";
      ...
      >
        ...
        <div className="sm:col-span-2 flex items-start gap-3">
          ...
          >
            ...
            meiner Anfrage gespeichert und verarbeitet werden. Die Einwilligung
            kann jederzeit widerrufen werden. Weitere Informationen in der{" "}
